...
- [Focus on PT (Pertussis Toxin) Ag](#focus-on-pt-pertussis-toxin-ag)
...
This can infect all ages but is most severe for those under 1 years of
age

The CDC track the number of reported cases in the US. We can “scrape”
this with **datapasta** package.
...
There were high case numbers in the pre-1940s. After the roll out of
this vaccine, the case numbers decrease dramatically. In the 1970s-90s,
cases are very low.
...
After the introduction of this new vaccine, which is considered safer
and with less side effects, cases starts climbing again. The problem
could be that no one was getting their boosters. the lag is very
consistant that suggests there is a problem with efficiency of this
vaccine. The aP protection wanes faster that wP- we do not know why
(hence the booster vaccines)

Interestingly, during the COVID years, cases decrease because social
distancing measures and lockdown stopped people from catching it.
...
Boost](https://www.cmi-pb.org/) project aimst o provide the scientific
...
> Asian females, White males etc…)? Is this dataset representative of
> the US population?
...
No it is not representative, as there are more women than mena and also,
there is not enough representation of some races.
...
To analyse this data we need to first “join” (merge/link) the different
...
> Q. Is there a temporal response - ie do values increase or decrease
> over time
